/*
 * GC2145 default init register table.
 *
 * Ported verbatim from Espressif's esp32-camera component (sensors/
 * private_include/gc2145_settings.h), which is Apache-2.0 - compatible with
 * ArgonOS's GPL-3.0.  Kept as data so the sensor driver is a loadable .SYS and
 * the register zoo never enters the firmware.
 *
 * SPDX-License-Identifier: Apache-2.0
 * Copyright (c) 2010-2022 Espressif Systems; adapted for ArgonOS 2026.
 */
#ifndef ARGON_GC2145_INIT_H
#define ARGON_GC2145_INIT_H
#include <stdint.h>
