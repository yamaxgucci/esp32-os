...
| [`power`](#power--частота-экран-и-оповещение) | ✅ 0.36 | что установлено, о чём система собирается попросить, и ответ, от которого зависит, останется ли процесс жив |
...
Появилась в **0.34**, правило снятия — в **0.35**, ступень `cruise` — в **0.36**.
