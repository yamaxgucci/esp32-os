...
Текущая версия ABI — **0.6**. Правила совместимости и то, как приложение
...
системного. Собранное против 0.1 работает на 0.2; собранное против 0.6 на 0.5 —
...
им пользуются колбэки `ag_dev_ops_t`. Подробности и пример —
