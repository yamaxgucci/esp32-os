...
| [`power`](#power--частота-экран-и-оповещение) | ✅ 0.35 | что установлено, о чём система собирается попросить, и ответ, от которого зависит, останется ли процесс жив |
...
Появилась в **0.34**, правило снятия — в **0.35**. Три вызова, и ни один из них
ничего не решает за приложение.
...
по себе, всё, что делает таймер простоя, и процесс, который ещё грузится.
